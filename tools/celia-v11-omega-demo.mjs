...
console.log(`Formal Z3: proof ${result.omega.formalZ3.proof} result ${result.omega.formalZ3.result} verified ${result.omega.formalZ3.verified} checks ${result.omega.formalZ3.checks} proofStr ${result.omega.formalZ3.proofStr}`);
